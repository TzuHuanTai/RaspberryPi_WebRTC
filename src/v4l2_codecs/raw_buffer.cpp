...
void RawBuffer::InitializeData() { memset(data_.get(), 0, size_); }

webrtc::VideoFrameBuffer::Type RawBuffer::type() const { return Type::kNative; }

int RawBuffer::width() const { return width_; }

int RawBuffer::height() const { return height_; }
...
unsigned int RawBuffer::Size() const { return static_cast<unsigned int>(size_); }

V4l2Buffer RawBuffer::GetBuffer() { return buffer_; }

const uint8_t *RawBuffer::Data() const { return data_.get(); }

uint8_t *RawBuffer::MutableData() { return const_cast<uint8_t *>(Data()); }
